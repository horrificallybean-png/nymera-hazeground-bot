...
export const configurationCommands: Command[] = [
  ...
  },
  {
    ...
    async execute(i) {
      ...
      await i.editReply(
        `Created **${categoryName}** with ${channel}. The daily check-in is set for **${hour.toString().padStart(2, "0")}:00** (${timezone}). Nymera will activate it automatically within one minute.`
      );
    }
  }
];
