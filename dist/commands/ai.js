...
export const aiCommands = [{
        ...
        async execute(i) {
            if (!i.guildId || !i.channelId)
                return void await i.reply({ content: "Use this in a server channel.", ephemeral: true });
            await i.deferReply();
    ...
    },
    {
        data: new SlashCommandBuilder().setName("ai-settings").setDescription("Configure Nymera's AI personality and safety features")
            ...
            .addStringOption(o => o.setName("mode").setDescription("Conversation personality").addChoices({ name: "Mystic", value: "mystic" }, { name: "Friendly", value: "friendly" }, { name: "Gothic Horror", value: "horror" }, { name: "Dead by Daylight", value: "dbd" }, { name: "Community Guide", value: "guide" }))
        ...
        async execute(i) {
            ...
            await i.reply({ embeds: [new EmbedBuilder().setColor(0x6f42c1).setTitle("Nymera AI Settings").addFields({ name: "Mode", value: updated.aiMode, inline: true }, { name: "Conversation engagement", value: updated.aiAutoReplyEnabled
                            ...
                            : "Off", inline: true }, { name: "Conversation starters", value: updated.aiConversationStarterEnabled
                            ...
                            : "Off", inline: true }, { name: "AI moderation", value: updated.aiModerationEnabled ? `Suggestions → ${updated.aiReviewChannelId ? `<#${updated.aiReviewChannelId}>` : "review channel not set"}` : "Off" })], ephemeral: true });
        }
    },
    {
